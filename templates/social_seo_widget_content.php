 ...
 if( $avgrating > 0) {
  ...
  $ndn = new wpsocial_DotNotation( $re );
    ...
    ?>
        ...
        <div class="wp-facebook-rew wpsocial-<?php echo esc_attr( $rev_type ); ?> <?php if( $dark_color){?> wp_dark <?php }?> widget wpsocial_review_Widget" itemprop="Review" itemscope itemtype="http://schema.org/Review">
